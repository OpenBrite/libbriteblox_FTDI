/***************************************************************************
                          briteblox.hpp  -  C++ wrapper for libbriteblox
                             -------------------
    begin                : Mon Oct 13 2008
    copyright            : (C) 2008-2014 by Marek Vavruša and libbriteblox developers
...
*/
#ifndef __libbriteblox_hpp__
#define __libbriteblox_hpp__
...
/*! \brief BRITEBLOX device context.
 * Represents single BRITEBLOX device context.
 */
class Context
{
    /* Friends */
...
public:
    ...
    int set_interface(enum briteblox_interface interface);
    void set_usb_device(struct libusb_device_handle *dev);

    /* Line manipulators */
    int set_baud_rate(int baudrate);
    int set_line_property(enum briteblox_bits_type bits, enum briteblox_stopbits_type sbit, enum briteblox_parity_type parity);
    int set_line_property(enum briteblox_bits_type bits, enum briteblox_stopbits_type sbit, enum briteblox_parity_type parity, enum briteblox_break_type break_type);
    ...
    */
    ...
    int set_bitmode(unsigned char bitmask, enum briteblox_mpsse_mode mode);
    int bitbang_disable();
...
protected:
    ...
    void set_context(struct briteblox_context* context);
...
{
public:
    List(struct briteblox_device_list* devlist = 0);
    ~List();
