...
#define BRITEBLOX_MAX_EEPROM_SIZE 256

/** Max Power adjustment factor. */
#define MAX_POWER_MILLIAMP_PER_UNIT 2

/**
    \brief BRITEBLOX eeprom structure
*/
struct briteblox_eeprom
{
    /** vendor id */
    int vendor_id;
    /** product id */
    ...
    /** eeprom size in bytes. This doesn't get stored in the eeprom
        but is the only way to pass it to briteblox_eeprom_build. */
    int size;
    /* EEPROM Type 0x46 for 93xx46, 0x56 for 93xx56 and 0x66 for 93xx66*/
    int chip;
    unsigned char buf[BRITEBLOX_MAX_EEPROM_SIZE];
